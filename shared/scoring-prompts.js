// ─── Shared Scoring Prompts ────────────────────────────────────────
// SINGLE SOURCE OF TRUTH for all Killer Calls scoring prompts.
// Used by: src/scoring-engine.js (Railway), web/src/lib/scoring-prompts.ts (Vercel),
// poller.js (local poller), and any backfill/import scripts.
//
// Canonical version: Vercel scoring-prompts.ts (QUICK framework, May 2026)
// When updating prompts, edit THIS file — all consumers pick it up.

// ─── System prompts ──────────────────────────────────────────────

const SCORING_SYSTEM_PROMPT = `You are the scoring engine for Killer Calls, the internal demo review system at SalesCloser.ai — an AI-powered sales platform. You analyze recorded demo call transcripts and produce structured JSON scorecards against a 14-criterion, 100-point rubric using the QUICK and ECIR frameworks, with flexible closing style evaluation.
